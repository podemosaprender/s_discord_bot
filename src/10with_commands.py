#FROM: https://github.com/Rapptz/discord.py/blob/v2.0.1/examples/app_commands/basic.py
...
async def add(interaction: discord.Interaction, first_value: int, second_value: int):
	...
	u= interaction.user
	print(f"USER: {u.id} {u.name} {u.display_name} {u.nick}")
...
async def report_message(interaction: discord.Interaction, message: discord.Message):
	...
	log_channel = interaction.guild.get_channel(REPORT_CH_ID)
